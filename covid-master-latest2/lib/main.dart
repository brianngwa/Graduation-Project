...
import './fragments/symptomInfoPage.dart';
import 'package:covid/routes/pagerRoute.dart';
import 'package:covid/fragments/uploadPCR.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
       ...
       pageRoutes.symptom: (context) => symptomInfoPage(),
       pageRoutes.pcr: (context) => uploadpcrPage(),
    });
